...
export const Config = z.object({
    ...
    ttsEngine: z.string().default('edge'),
    voiceMapJson: z.string().default('{"ginka":"zh-CN-XiaoxiaoNeural","制导方案研究员":"zh-CN-YunjianNeural","开源复现工程师":"zh-CN-YunyangNeural","机载视觉可行性研究员":"zh-CN-YunxiNeural","学习计划整理师":"zh-CN-YunxiaNeural","default":"zh-CN-YunxiNeural"}'),
...
const DEFAULTS = {
    ...
    ttsEngine: 'edge',
    voiceMapJson: '{"ginka":"zh-CN-XiaoxiaoNeural","制导方案研究员":"zh-CN-YunjianNeural","开源复现工程师":"zh-CN-YunyangNeural","机载视觉可行性研究员":"zh-CN-YunxiNeural","学习计划整理师":"zh-CN-YunxiaNeural","default":"zh-CN-YunxiNeural"}',
...
/* Edge 微软神经音色目录（官方清单全部 14 款中文音色，含风格标注）
   来源：speech.platform.bing.com/consumer/speech/synthesize/readaloud/voices/list */
const EDGE_VOICES = [
    { id: 'zh-CN-XiaoxiaoNeural', gender: '女声', style: '晓晓 · 温柔亲切' },
    { id: 'zh-CN-XiaoyiNeural', gender: '女声', style: '晓伊 · 活泼可爱' },
    { id: 'zh-CN-YunxiNeural', gender: '男声', style: '云希 · 阳光青年' },
    { id: 'zh-CN-YunjianNeural', gender: '男声', style: '云健 · 沉稳有力（解说风）' },
    { id: 'zh-CN-YunyangNeural', gender: '男声', style: '云扬 · 专业播报（新闻风）' },
    { id: 'zh-CN-YunxiaNeural', gender: '男声', style: '云夏 · 少年感' },
    { id: 'zh-CN-liaoning-XiaobeiNeural', gender: '女声', style: '晓北 · 东北口音' },
    { id: 'zh-CN-shaanxi-XiaoniNeural', gender: '女声', style: '晓妮 · 陕西口音' },
    { id: 'zh-HK-HiuGaaiNeural', gender: '女声', style: '曉佳 · 粤语女声' },
    { id: 'zh-HK-HiuMaanNeural', gender: '女声', style: '曉曼 · 粤语女声' },
    { id: 'zh-HK-WanLungNeural', gender: '男声', style: '雲龍 · 粤语男声' },
    { id: 'zh-TW-HsiaoChenNeural', gender: '女声', style: '曉臻 · 台湾女声' },
    { id: 'zh-TW-HsiaoYuNeural', gender: '女声', style: '曉雨 · 台湾女声' },
    { id: 'zh-TW-YunJheNeural', gender: '男声', style: '雲哲 · 台湾男声' },
];
...
export function apply(ctx, config) {
    ...
    /* Kokoro 与 Edge 双引擎并存：Kokoro 后台加载（模型存在时），选择 kokoro 声线即走本地引擎 */
        ...
        ctx.effect(() => webServer.register({
            ...
            handler: async (req, res) => {
                ...
                try {
                    ...
                    /* Kokoro 声线（zf_ / zm_ 编号）走本地引擎；Edge 声线（zh- 前缀）走在线引擎 */
                    if (ttsState.ready) {
                        try {
                    ...
                    let mp3;
                    try {
                        mp3 = await edgeSynthesize(text, edgeVoice);
                    } catch (error) {
                        /* 个别音色不可用时回退默认女声，保证试听/播报永远有声音 */
                        ctx.logger?.warn(`captain-call: edge voice ${edgeVoice} failed (${String(error)}), fallback to Xiaoxiao`);
                        mp3 = await edgeSynthesize(text, 'zh-CN-XiaoxiaoNeural');
                    }
